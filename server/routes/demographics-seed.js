...
router.post('/', async (req, res) => {
  try {
    ...
    const profileResult = await pool.query(
      `INSERT INTO user_profile (display_name, date_of_birth, state_of_residence, filing_status, employment_status)
       VALUES ($1, $2, $3, $4, $5)
       RETURNING id`,
      [
        profile.displayName,
    ...
    if (Array.isArray(household)) {
      for (const member of household) {
        await pool.query(
          `INSERT INTO household_members (user_id, relationship, name, age_years)
           VALUES ($1, $2, $3, $4)`,
          [
            userId,
