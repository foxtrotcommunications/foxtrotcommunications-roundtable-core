...
VALUES
  ('acct_ret_001', 'sec_vttvx',  8200.00,  22.18, 181876.00, 148000.00),
  ('acct_ret_001', 'sec_vfiax',   180.00, 523.40,  94212.00,  72000.00),
  ('acct_ret_001', 'sec_vbtlx',  3200.00,  10.85,  34720.00,  35000.00),
  ('acct_ret_001', 'sec_vtiax',   950.00,  33.72,  32034.00,  28500.00),
  -- Roth IRA: growth-oriented
  ('acct_ret_002', 'sec_swppx',   450.00,  83.95,  37777.50,  31500.00),
  ('acct_ret_002', 'sec_swisx',   680.00,  24.60,  16728.00,  15000.00),
  ('acct_ret_002', 'sec_swagx',  1360.00,  10.22,  13899.20,  14000.00)
