...
VALUES (1, 'Demo User', '1991-03-15', 'male', 'IL', 'married_filing_jointly', 'bachelors_degree', 'employed_full_time', 'DemoGraphicsWs01xYz')
...
INSERT INTO household_members (user_id, relationship, name, date_of_birth, age_years, workspace_id) VALUES
  (1, 'spouse', 'Spouse', '1992-07-20', 33, 'DemoGraphicsWs01xYz'),
  (1, 'child', 'Child 1', '2021-04-10', 5, 'DemoGraphicsWs01xYz'),
  (1, 'child', 'Child 2', '2023-02-15', 3, 'DemoGraphicsWs01xYz'),
  (1, 'child', 'Child 3', '2025-06-01', 1, 'DemoGraphicsWs01xYz');
...
VALUES (1, 'conservative', 'high', 'long_term',
  ...
  'Risk averse. Prefers liquidity and capital preservation over aggressive growth. With 3 young children, emergency reserves and stability are priorities.', 'DemoGraphicsWs01xYz');
