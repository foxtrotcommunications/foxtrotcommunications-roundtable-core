...
const tool = {
    ...
    description: 'Search and filter transactions with flexible criteria. Supports filtering by account, date range, amount range, category, and free-text search across name/merchant/category. Returns transactions with total count, total amount, and applied filters.',
    parameters: {
        type: 'object',
        properties: {
            account_id: {
...
export default tool;
//# sourceMappingURL=getTransactions%202.js.map