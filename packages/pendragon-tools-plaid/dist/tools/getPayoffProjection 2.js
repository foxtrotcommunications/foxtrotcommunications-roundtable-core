...
const tool = {
    ...
    description: 'Calculate debt payoff projections using snowball (lowest balance first) and avalanche ' +
    ...
    async execute(args, _workspaceConfig = {}) {
      ...
      `;
            ...
            if (debts.length === 0)
                metadata.coverage.gaps.push('No active liabilities with balances found');
...
export default tool;
//# sourceMappingURL=getPayoffProjection%202.js.map