...
const tool = {
    ...
    description: 'Aggregate spending from plaid_transactions grouped by merchant_name. ' +
    ...
    async execute(args, _workspaceConfig = {}) {
      ...
      `;
            ...
            const merchants = result.rows.map((r) => ({
                merchant: r.merchant,
            ...
            const transactionsScanned = merchants.reduce((sum, m) => sum + m.count, 0);
            ...
            return {
                ...
                chart: {
                    ...
                    values: merchants.map((m) => m.total),
                },
...
export default tool;
//# sourceMappingURL=getSpendingByMerchant%202.js.map